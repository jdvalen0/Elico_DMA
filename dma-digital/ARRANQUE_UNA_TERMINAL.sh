...
# Script para arrancar Backend y Frontend en una sola terminal
# Ejecuta: bash ARRANQUE_UNA_TERMINAL.sh
...
echo "   1. Presiona Ctrl+C aquí (detiene frontend)"
echo "   2. Luego ejecuta: kill $BACKEND_PID (detiene backend)"
echo ""
